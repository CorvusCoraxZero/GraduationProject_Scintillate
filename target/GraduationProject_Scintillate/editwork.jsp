        ...
        <div id="work_msg_div">
            <div class="form-group " id="input_div1">
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <input type="text" class="form-control" id="work_name" placeholder="请输入作品名称">
                </div>
            </div>
            <div class="form-group">
                <div class="col-md-10 col-md-offset-1">
                    <label for="work_introduce">简介：</label>
                    <textarea class="form-control" rows="3" id="work_introduce" placeholder="请输入作品简介（200字以内）"></textarea>
                </div>
            </div>
            <div class="form-group">
                <div class="col-md-10 col-md-offset-1">
                    <label for="work_tags">标签：(小于10个)</label>
                    <input type="text" class="form-control" id="work_tags" placeholder="请输出标签（例:#天空 #白云）">
                </div>
            </div>
            <div class="form-group">
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <div id = "input_gender">
                        <label class="radio-inline">
                            <input type="radio" name="optionsRadiosinline" id="optionsRadios1" value="0" checked> 18
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="optionsRadiosinline" id="optionsRadios2" value="1"> R18
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="optionsRadiosinline" id="optionsRadios3" value="2"> R18G
                        </label>
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="col-md-offset-5 col-md-2 btn-area">
                    <button type="button" class="btn btn-info pixiv_btn"style="padding: 5px 42px" id="btn_publish">完成</button>
                </div>
                <div class="col-md-offset-5 col-md-2 btn-area" style="margin-top: 5px;">
                    <button type="button" class="btn btn-warning pixiv_btn" style="padding: 5px 42px;background:#ff3328;" id="btn_delete">删除</button>
                </div>
            </div>
        </div>
    </form>
