...
<body>
    ...
    <div id="page_content" class="col-md-8 col-md-offset-1">
            <a href="img/bg1.jpg" class="thumbnail work_a_img" style="margin-bottom: 0;">
        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            <span id="work_publish_time">2020年5月4日 11:00</span>
        </div>
        <div id="center_author_content" class="col-md-10 col-md-offset-1">
            <a class="author_name col-md-4"><img src="img/bg1.jpg" alt="..." width="50px" height="50px" class="img-circle"> 困困的小鑫</a>
        ...
        <div class="col-md-8 col-md-offset-2" id="comment">
            ...
            <div class="coments">
                <div class="comments_photo col-md-1">
                    <a class="col-md-12"><img src="img/bg1.jpg" alt="..." width="40px" height="40px" class="img-circle"></a>
                </div>
                <div class="col-md-10">
    ...
    <div id="righr_author_content" class="col-md-2" >
        <a class="author_name "><img src="img/bg1.jpg" alt="..." width="50px" height="50px" class="img-circle"> 困困的小鑫</a>
